 ...
 */
const MessageList = ({ messages, userId, isActive, isTyping, partnerAvatarSeed, onReply, unsendMessage }) => {
  ...
  return (
    <div className="flex-1 min-h-0 overflow-y-auto overscroll-contain px-3 sm:px-6 py-4 flex flex-col gap-3"
