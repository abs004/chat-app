    ...
    <div className="min-h-screen bg-[#0D0F12] flex items-center justify-center p-4">
      <div className="w-full max-w-[900px] min-h-[520px] rounded-2xl overflow-hidden shadow-[0_32px_80px_rgba(0,0,0,0.6)] flex">
        ...
        <div className="relative hidden md:flex flex-col justify-between w-[45%] bg-[#111418] p-10 overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-[#6B7280] text-sm leading-relaxed">
              Make it a good one! You'll use this to get back into your account.
            </p>
          </div>
        ...
        <div className="flex-1 bg-white flex flex-col justify-center px-10 py-12">
          ...
          {!success ? (
            <>
              <p className="text-xs font-semibold text-emerald-500 tracking-widest uppercase mb-2">Almost there</p>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                <div>
                  <label htmlFor="new-password" className="block text-xs font-semibold text-gray-500 mb-1.5 uppercase tracking-wide">
                    New Password
                  </label>
                  <div className="relative">
                    ...
                    <button
                      ...
                      tabIndex={0}
                      disabled={loading || !token}
                      className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 rounded disabled:opacity-50"
                    >
                      {showPassword ? <EyeOff size={17} /> : <Eye size={17} />}
                    </button>
                  </div>
                  <p className="text-[11px] text-gray-400 mt-1.5 ml-1">Must be at least 8 characters.</p>
                </div>

                <div>
                  <label htmlFor="confirm-password" className="block text-xs font-semibold text-gray-500 mb-1.5 uppercase tracking-wide">
                    Confirm Password
                  </label>
                  <div className="relative">
                    <input
                ...
                <button
                  type="submit"
                  disabled={loading || !token}
                  className="w-full mt-4 py-3 px-6 text-sm font-semibold text-white bg-emerald-500 rounded-xl transition-all duration-150 hover:bg-emerald-600 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_4px_14px_rgba(16,185,129,0.35)] hover:shadow-[0_6px_20px_rgba(16,185,129,0.45)]"
                >
                  {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-6 text-center">
              ...
              <Link
                to="/login"
                className="w-full py-3 px-6 text-sm font-semibold text-white bg-emerald-500 rounded-xl transition-all duration-150 hover:bg-emerald-600 active:scale-[0.98] shadow-[0_4px_14px_rgba(16,185,129,0.35)]"
              >
                Back to Sign in
              </Link>
            </div>
